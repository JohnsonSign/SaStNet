...
import os
#ROOT_DATASET = '/data/dataset/'
ROOT_DATASET = '/home/yckj3949/data/somthing/v1/'
# ROOT_DATASET = '/ssd1/szq/something/v2/'
...
def return_hmdb51(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET + "hmdb51-RGB" #"/ssd/szq/hmdb51_RGB" ## 视频文件夹的上一层路径
        # filename_imglist_train = "hmdb51_rgb_train_split_3.txt"
        # filename_imglist_val = "hmdb51_rgb_val_split_3.txt"
        filename_imglist_train = "hmdb51-splits/hmdb51_rgb_train_split_3.txt" ## ROOT_DATASET下路径
        filename_imglist_val = "hmdb51-splits/hmdb51_rgb_val_split_3.txt"
        # prefix = 'image_{:05d}.jpg'
        prefix = 'img_{:05d}.jpg' 
    elif modality == 'Flow':
...
def return_something(modality):
    ...
    if modality == 'RGB' or modality== 'RGBDiff':
        root_data = ROOT_DATASET + 'img' # yuncong
        #root_data = ROOT_DATASET + 'somethingv1-frame' # ps
        filename_imglist_train =  "sthv1_splits/train_videofolder.txt"
        filename_imglist_val = "sthv1_splits/val_videofolder.txt"
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
...
def return_somethingv2(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'img' # yuncong
        filename_imglist_train =  "sthv2_splits/train_videofolder.txt"
        filename_imglist_val = "sthv2_splits/val_videofolder.txt"
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
...
def return_dataset(dataset, modality):
    ...
    if dataset in dict_single:
        ...
        if dataset == 'UAVHuman':
            file_imglist_train = '/home/yckj3949/action/TDN-mask-0819-2-copy-3-backup-human-dataset/ops/uavhuman_train_cross_subject2.txt'
            file_imglist_val = '/home/yckj3949/action/TDN-mask-0819-2-copy-3-backup-human-dataset/ops/uavhuman_test_cross_subject2.txt'
            root_data = '/home/yckj3949/data/uavhuman/all_rgb_frame'
            prefix = '{:06d}.jpg'
            return 155, file_imglist_train, file_imglist_val, root_data, prefix
        else:
